...
class Config(context: Context) : BaseConfig(context) {
    ...
    var wallStartMode: Boolean
        get() = prefs.getBoolean(WALL_START_MODE, true)
        set(enabled) = prefs.edit().putBoolean(WALL_START_MODE, enabled).apply()

    var wallDisplayMode: String
    ...
    var wallOrientation: String
        get() = prefs.getString(WALL_ORIENTATION, "landscape") ?: "landscape"
        set(orientation) = prefs.edit().putString(WALL_ORIENTATION, orientation).apply()

    var wallWeekStart: String
        get() = prefs.getString(WALL_WEEK_START, "today") ?: "today"
        set(start) = prefs.edit().putString(WALL_WEEK_START, start).apply()

    var wallShowLocalCalendar: Boolean
    ...
    var weatherLabel: String
        get() = prefs.getString(WEATHER_LABEL, "") ?: ""
        set(label) = prefs.edit().putString(WEATHER_LABEL, label).apply()
