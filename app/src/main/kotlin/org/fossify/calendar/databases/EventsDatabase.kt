...
abstract class EventsDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.apply {
                    execSQL("ALTER TABLE event_types ADD COLUMN web_sync_mode TEXT NOT NULL DEFAULT 'local'")
                    execSQL("ALTER TABLE event_types ADD COLUMN web_sync_url TEXT NOT NULL DEFAULT ''")
                    execSQL("ALTER TABLE event_types ADD COLUMN web_sync_interval_minutes INTEGER NOT NULL DEFAULT 15")
                    execSQL("ALTER TABLE event_types ADD COLUMN web_read_only INTEGER NOT NULL DEFAULT 0")
                    execSQL("ALTER TABLE event_types ADD COLUMN web_sync_last_updated INTEGER NOT NULL DEFAULT 0")
                    execSQL("ALTER TABLE event_types ADD COLUMN web_sync_last_error TEXT NOT NULL DEFAULT ''")
                }
            }
        }
    }
